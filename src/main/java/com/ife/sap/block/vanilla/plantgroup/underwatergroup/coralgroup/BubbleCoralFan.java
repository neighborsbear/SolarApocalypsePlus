...
import static net.minecraft.world.level.block.Blocks.DEAD_BUBBLE_CORAL_FAN;

public class BubbleCoralFan extends CoralFanBlock {
    public BubbleCoralFan() {
        super(VanillaBlocks.DEAD_BUBBLE_CORAL_FAN.get(), Properties.copy(Blocks.BUBBLE_CORAL_FAN).randomTicks());
    }
